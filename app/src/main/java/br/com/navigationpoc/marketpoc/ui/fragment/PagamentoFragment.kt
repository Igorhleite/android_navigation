package br.com.navigationpoc.marketpoc.ui.fragment
...
import br.com.navigationpoc.marketpoc.extensions.formatParaMoedaBrasileira
...
class PagamentoFragment : Fragment() {
    ...
    private fun goToProductList() {controlador.navigate(PagamentoFragmentDirections.toProductListFragment())} // util -> popBackStack
